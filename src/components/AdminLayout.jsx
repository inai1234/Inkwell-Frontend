...
export default function AdminLayout() {
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-100">
        ...
        <div>
          <p className="text-base font-bold text-textPrimary leading-none">
            Inkwell<span className="text-primary">.</span>
          </p>
          <p className="text-xs text-textSecondary mt-0.5">Admin Panel</p>
        </div>
      </div>
      ...
      <div className="px-4 py-4 border-t border-gray-100">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium text-red-500 hover:bg-red-50 transition-colors duration-200"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      {/* Desktop Sidebar */}
      <aside className="hidden lg:flex lg:flex-col w-64 bg-white border-r border-gray-100 shadow-sm flex-shrink-0">
        <SidebarContent />
      </aside>
      ...
      {/* Mobile Sidebar */}
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-100 shadow-xl transition-transform duration-300 lg:hidden ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <SidebarContent />
      </aside>
        ...
        <header className="bg-white border-b border-gray-100 px-4 sm:px-6 py-4 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:flex items-center gap-1.5 text-sm text-gray-500">
              <a href="https://inkwell-gamma-ten.vercel.app/" target="_blank" rel="noopener noreferrer"
